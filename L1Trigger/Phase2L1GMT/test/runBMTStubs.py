...
process.bmtStubs = cms.EDProducer("Phase2L1TGMTStubProducer",
                                  verbose = cms.int32(0),
                                  ...
                                  Endcap =cms.PSet(                            
                                      ...
                                      minBX                = cms.int32(-500),                           
                                      maxBX                = cms.int32(-500),         
                                      coord1LSB            = cms.double(0.00076660156), 
                                      eta1LSB              = cms.double(7.68334e-04), 
                                      coord2LSB            = cms.double(0.00076660156), 
...
process.testpath=cms.Path(process.CalibratedDigis*process.dtTriggerPhase2PrimitiveDigis*process.bmtStubs)
process.endjob_step = cms.EndPath(process.endOfProcess)
process.FEVTDEBUGHLToutput_step = cms.EndPath(process.FEVTDEBUGHLToutput)

# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.testpath,process.endjob_step,process.FEVTDEBUGHLToutput_step)
