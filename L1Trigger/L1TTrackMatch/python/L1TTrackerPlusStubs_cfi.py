...
l1BarrelRPCStubsForTPS = cms.EDProducer("L1TMuonBarrelRPCKalmanStubProducer",
    verbose = cms.int32(0),
    srcPhi = cms.InputTag("simMuonRPCDigis"),
    minPhiQuality = cms.int32(0),
    minThetaQuality = cms.int32(0),
    minBX = cms.int32(0),                           
    maxBX = cms.int32(0),                           
...
l1TrackerPlusStubsSequence = cms.Sequence(l1DTStubsForTPS*l1BarrelRPCStubsForTPS*l1StubMatchedMuons)
