...
process.DTTPG.FirstBX = cms.untracked.int32(20)
process.DTTPG.LastBX = cms.untracked.int32(20)


# Path and EndPath nitions

process.dtPhase2 = cms.Path(process.CalibratedDigis*process.dtTriggerPhase2PrimitiveDigis*process.l1Phase2TPSStubs)
process.dtHough   = cms.Path(process.DTTPG)
process.L1simulation_step = cms.Path(process.SimL1Emulator)
process.endjob_step = cms.EndPath(process.endOfProcess)
process.FEVTDEBUGHLToutput_step = cms.EndPath(process.FEVTDEBUGHLToutput)

# Schedule definition
process.schedule = cms.Schedule(process.L1simulation_step,process.dtPhase2,process.endjob_step,process.FEVTDEBUGHLToutput_step)
